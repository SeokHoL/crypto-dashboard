package com.seokho.currencymonitor.controller;

import com.seokho.currencymonitor.model.currency.CurrencyResponse;
import com.seokho.currencymonitor.service.ExchangeService;
...
public class CurrencyController {
    ...
    @GetMapping("/{currency}") // currency 는 USD
